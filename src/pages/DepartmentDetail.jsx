import React,{useState} from 'react';
 ...
 <Link to="/" className="mt-6 inline-block bg-teal-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-teal-700">
 Go Back to Home
 </Link>
 </div>
 </div>
 ...
 <p className="text-lg text-teal-100 mt-2 font-medium">Comprehensive Medical Care</p>
 </div>
 </div>
