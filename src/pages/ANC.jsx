...
const ANC = () => {
    ...
    const departmentData = {
        ...
        services: [
            { name: 'Routine Antenatal Checkups', description: 'Regular monitoring of maternal and fetal health throughout pregnancy with comprehensive assessments.', icon: FiHeart, procedures: ['Weight & BP Monitoring', 'Fetal Heart Rate Check', 'Growth Assessment', 'Blood & Urine Tests'], stats: { patients: '1.5K+', success: '98%' }, image: '/anc/Routine Antenatal Checkups.jpg' },
            { name: 'Ultrasound & Imaging', description: 'Advanced imaging for fetal development tracking, anomaly screening, and growth monitoring.', icon: FiMonitor, procedures: ['Dating Scan', 'Anomaly Scan', 'Growth Scan', 'Doppler Studies'], stats: { patients: '1.8K+', success: '99%' }, image: '/anc/Ultrasound & Imaging.jpg' },
            { name: 'High-Risk Pregnancy Care', description: 'Specialized care for high-risk pregnancies with expert monitoring and management.', icon: FiShield, procedures: ['Gestational Diabetes Care', 'Preeclampsia Management', 'Multiple Pregnancy Care', 'Genetic Counseling'], stats: { patients: '600+', success: '96%' }, image: '/obg/High-Risk Pregnancy.jpg' },
            { name: 'Prenatal Testing', description: 'Comprehensive screening and diagnostic tests for fetal health and genetic conditions.', icon: FiTarget, procedures: ['Double Marker Test', 'Triple Marker Test', 'Amniocentesis', 'NIPT'], stats: { patients: '1.2K+', success: '99%' }, image: '/anc/Prenatal Testing.jpg' },
            { name: 'Childbirth Preparation', description: 'Comprehensive education and preparation classes for expectant parents.', icon: FiUsers, procedures: ['Lamaze Classes', 'Breastfeeding Support', 'Pain Management', 'Newborn Care'], stats: { patients: '800+', success: '100%' }, image: '/anc/Childbirth Preparation.jpg' },
            { name: 'Nutrition Counseling', description: 'Expert nutritional guidance for healthy pregnancy and optimal fetal development.', icon: FiActivity, procedures: ['Diet Planning', 'Supplement Guidance', 'Weight Management', 'Diabetic Diet'], stats: { patients: '1.5K+', success: '95%' }, image: '/anc/Nutrition Counseling.jpg' }
        ],
        doctors: [
        ...
        contact: { phone: '+91 70908 31208', email: 'Jananihospital2018@gmail.com', location: 'Block K, 1st Floor', hours: 'Mon-Sat: 8 AM - 6 PM | Sun: 9 AM - 2 PM' },
        faq: [
                        ...
                        <div className="text-white max-w-4xl">
                            <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-teal-500/30 backdrop-blur-md rounded-xl sm:rounded-2xl flex items-center justify-center border-2 border-teal-400/50 shadow-xl flex-shrink-0">
                                    <SafeIcon icon={FiUsers} className="text-2xl sm:text-3xl md:text-4xl text-white" />
                                </div>
                                <div>
                                    <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight leading-tight">{departmentData.name}</h1>
                                    <p className="text-sm sm:text-base md:text-lg text-teal-100 mt-1 sm:mt-2 font-medium">Comprehensive Pregnancy Care</p>
                                </div>
                            </div>
