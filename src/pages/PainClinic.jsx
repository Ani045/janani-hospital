...
const PainClinic = () => {
    ...
    const departmentData = {
        ...
        services: [
            { name: 'Chronic Back Pain', description: 'Comprehensive management of chronic back and neck pain using advanced interventional techniques and therapy.', icon: FiActivity, procedures: ['Epidural Injections', 'Facet Joint Blocks', 'Radiofrequency Ablation', 'Spinal Cord Stimulation'], stats: { patients: '650+', success: '85%' }, image: '/pain_clinic/Chronic Back Pain.jpg' },
            { name: 'Nerve Block Therapy', description: 'Targeted nerve blocks and injections for precise pain relief and diagnosis of pain conditions.', icon: FiZap, procedures: ['Selective Nerve Blocks', 'Sympathetic Blocks', 'Trigger Point Injections', 'Joint Injections'], stats: { patients: '480+', success: '90%' }, image: '/pain_clinic/Nerve Block Therapy.jpg' },
            { name: 'Arthritis Management', description: 'Specialized treatment for arthritis pain using joint injections and advanced pain management techniques.', icon: FiShield, procedures: ['Intra-articular Injections', 'Hyaluronic Acid Therapy', 'PRP Injections', 'Physical Therapy'], stats: { patients: '420+', success: '82%' }, image: '/pain_clinic/Arthritis Management.jpg' },
            { name: 'Headache & Migraine', description: 'Advanced treatment for chronic headaches and migraines using targeted interventions and preventive therapy.', icon: FiMonitor, procedures: ['Botox Injections', 'Occipital Nerve Blocks', 'Trigger Point Therapy', 'Migraine Prophylaxis'], stats: { patients: '380+', success: '86%' }, image: '/pain_clinic/Headache & Migraine.jpg' },
            { name: 'Cancer Pain Relief', description: 'Compassionate and effective pain management for cancer patients using multimodal approaches.', icon: FiUsers, procedures: ['Opioid Management', 'Nerve Blocks', 'Palliative Care', 'Intrathecal Pumps'], stats: { patients: '280+', success: '89%' }, image: '/pain_clinic/Cancer Pain Relief.jpg' },
            { name: 'Neuropathic Pain', description: 'Specialized treatment for nerve-related pain conditions including diabetic neuropathy and post-herpetic neuralgia.', icon: FiTarget, procedures: ['Nerve Stimulation', 'Medication Management', 'Topical Therapy', 'Neuromodulation'], stats: { patients: '320+', success: '84%' }, image: '/pain_clinic/Neuropathic Pain.jpg' }
        ],
        doctors: [
        ...
        contact: { phone: '+91 70908 31208', email: 'Jananihospital2018@gmail.com', location: 'Block L, 1st Floor', hours: 'Mon-Sat: 9 AM - 6 PM | Sun: Closed' },
        faq: [
                        ...
                        <div className="text-white max-w-4xl">
                            <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-teal-500/30 backdrop-blur-md rounded-xl sm:rounded-2xl flex items-center justify-center border-2 border-teal-400/50 shadow-xl flex-shrink-0">
                                    <SafeIcon icon={FiZap} className="text-2xl sm:text-3xl md:text-4xl text-white" />
                                </div>
                                <div>
                                    <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight leading-tight">{departmentData.name}</h1>
                                    <p className="text-sm sm:text-base md:text-lg text-teal-100 mt-1 sm:mt-2 font-medium">Advanced Pain Relief Solutions</p>
                                </div>
                            </div>
