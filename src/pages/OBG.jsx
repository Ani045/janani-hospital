...
const {
    ...
    FiMonitor, FiTool, FiChevronDown,
} = FiIcons;
...
const OBG = () => {
    ...
    const departmentData = {
        ...
        hero: '/Obstetrics&Gynecology.png',
        ...
        services: [
            { name: 'Normal & Cesarean Delivery', description: 'Comprehensive delivery care with expert obstetric management for both normal and cesarean births in a safe environment.', icon: FiBaby, procedures: ['Normal Delivery', 'Cesarean Section', 'VBAC', 'Water Birth'], stats: { patients: '2.5K+', success: '99%' }, image: '/obg/Normal & Cesarean Delivery.jpg' },
            { name: 'High-Risk Pregnancy', description: 'Specialized care for high-risk pregnancies with advanced monitoring and expert management throughout pregnancy.', icon: FiShield, procedures: ['Preeclampsia Management', 'Gestational Diabetes', 'Multiple Pregnancy', 'Placenta Complications'], stats: { patients: '1.8K+', success: '97%' }, image: '/obg/High-Risk Pregnancy.jpg' },
            { name: 'Gynecological Surgery', description: 'Minimally invasive and traditional gynecological procedures for various women\'s health conditions and disorders.', icon: FiActivity, procedures: ['Hysterectomy', 'Ovarian Cyst Removal', 'Fibroid Surgery', 'Endometriosis Treatment'], stats: { patients: '2K+', success: '98%' }, image: '/obg/Gynecological Surgery.jpg' },
            { name: 'Fertility Treatment', description: 'Comprehensive fertility evaluation and treatment options for couples facing conception challenges and reproductive issues.', icon: FiHeart, procedures: ['Fertility Assessment', 'Ovulation Induction', 'IUI Procedures', 'Fertility Counseling'], stats: { patients: '1.5K+', success: '65%' }, image: '/obg/Fertility Treatment.jpg' },
            { name: 'Prenatal Care', description: 'Complete antenatal care with regular monitoring, screening tests, and health guidance throughout pregnancy journey.', icon: FiMonitor, procedures: ['Regular Check-ups', 'Ultrasound Scans', 'Genetic Screening', 'Birth Planning'], stats: { patients: '3K+', success: '99%' }, image: '/obg/Prenatal Care.jpg' },
            { name: 'Women\'s Health Screening', description: 'Comprehensive preventive healthcare screening for early detection and prevention of women\'s health issues.', icon: FiTarget, procedures: ['Pap Smears', 'Mammography', 'Bone Density Tests', 'HPV Screening'], stats: { patients: '2.5K+', success: '95%' }, image: '/obg/Women Health Screening.jpg' }
        ],
        doctors: [
                        ...
                        <div className="text-white max-w-4xl">
                            <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base md:text-lg text-teal-100 mt-1 sm:mt-2 font-medium">Comprehensive Women's Healthcare</p>
                                </div>
                            </div>
