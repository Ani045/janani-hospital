...
const {
    ...
    FiZap, FiChevronDown, FiScissors, FiActivity, FiGlobe, FiEye
} = FiIcons;
...
const Hysteroscopy = () => {
    ...
    const departmentData = {
        ...
        hero: '/Hysteroscopy.webp',
        description: 'Our Hysteroscopy Department offers advanced minimally invasive procedures for diagnosing and treating uterine conditions with precision and minimal recovery time.',
        overviewStats: [
            { icon: FiEye, number: '1.8K+', label: 'Procedures Done' },
            { icon: FiAward, number: '98%', label: 'Success Rate' },
            { icon: FiUsers, number: '12+', label: 'Expert Specialists' },
            { icon: FiClock, number: '24/7', label: 'Support Available' }
        ],
        highlights: ['Advanced HD Hysteroscopy Technology', 'Office-Based Procedures', 'Minimal Invasive Techniques', 'Expert Gynecological Team', 'Same-Day Procedures Available', 'Comprehensive Female Care'],
        services: [
            { name: 'Diagnostic Hysteroscopy', description: 'Advanced visualization of the uterine cavity for accurate diagnosis of various gynecological conditions.', icon: FiEye, procedures: ['Uterine Cavity Assessment', 'Abnormal Bleeding Investigation', 'Fertility Evaluation', 'Polyp Detection'], stats: { patients: '800+', success: '99%' }, image: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Operative Hysteroscopy', description: 'Therapeutic procedures to treat uterine conditions with precision and minimal recovery time.', icon: FiScissors, procedures: ['Polyp Removal', 'Fibroid Resection', 'Septum Correction', 'Adhesion Treatment'], stats: { patients: '600+', success: '97%' }, image: 'https://images.unsplash.com/photo-1581093452422-48b4f3b8f5b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Fertility Enhancement', description: 'Specialized procedures to improve fertility outcomes through uterine cavity optimization.', icon: FiHeart, procedures: ['Uterine Septum Repair', 'Asherman Syndrome Treatment', 'Endometrial Assessment', 'Tubal Cannulation'], stats: { patients: '400+', success: '85%' }, image: 'https://images.unsplash.com/photo-1579154212918-0a1f7c2f0f8a?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Abnormal Bleeding Management', description: 'Comprehensive evaluation and treatment of abnormal uterine bleeding conditions.', icon: FiActivity, procedures: ['Endometrial Biopsy', 'Polyp Removal', 'Fibroid Treatment', 'Hormonal Assessment'], stats: { patients: '700+', success: '95%' }, image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Post-Menopausal Care', description: 'Specialized hysteroscopic procedures for post-menopausal women addressing specific concerns.', icon: FiShield, procedures: ['Endometrial Assessment', 'Polyp Management', 'Bleeding Investigation', 'Cancer Screening'], stats: { patients: '300+', success: '98%' }, image: 'https://images.unsplash.com/photo-1584362917165-526a968579e8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Office Hysteroscopy', description: 'Convenient in-office procedures with minimal discomfort and no anesthesia required.', icon: FiMonitor, procedures: ['Diagnostic Assessment', 'Minor Interventions', 'Biopsy Procedures', 'IUD Removal'], stats: { patients: '500+', success: '99%' }, image: 'https://images.unsplash.com/photo-1628771065518-0d82f1938462?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' }
        ],
        doctors: [
            { name: 'Dr. Priya Sharma', specialization: 'Senior Gynecologist & Hysteroscopist', experience: '16 years', image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.9, expertise: ['Advanced Hysteroscopy', 'Fertility Enhancement', 'Operative Procedures'] },
            { name: 'Dr. Kavya Reddy', specialization: 'Reproductive Endocrinologist', experience: '14 years', image: 'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.8, expertise: ['Fertility Procedures', 'Hormonal Disorders', 'Reproductive Surgery'] },
            { name: 'Dr. Anjali Patel', specialization: 'Minimally Invasive Gynecologist', experience: '12 years', image: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.8, expertise: ['Office Hysteroscopy', 'Abnormal Bleeding', 'Polyp Management'] },
            { name: 'Dr. Meera Gupta', specialization: 'Gynecological Oncologist', experience: '18 years', image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.9, expertise: ['Cancer Screening', 'Advanced Procedures', 'Post-menopausal Care'] }
        ],
        technology: [
            { name: 'HD Hysteroscopy Systems', description: 'High-definition cameras for detailed visualization of uterine cavity.', icon: FiMonitor },
            { name: 'Bipolar Resection System', description: 'Advanced energy system for safe tissue removal procedures.', icon: FiTool },
            { name: 'Office-Based Equipment', description: 'Specialized instruments for comfortable in-office procedures.', icon: FiEye },
            { name: 'Digital Documentation', description: 'Advanced imaging and recording systems for precise documentation.', icon: FiGlobe }
        ],
        facilities: ['Advanced HD Hysteroscopy Suites', 'Office-Based Procedure Rooms', 'Dedicated Recovery Areas', 'Female-Only Spaces', 'Specialized Gynec Equipment', 'Digital Imaging Systems', 'Patient Comfort Amenities', 'Expert Nursing Support'],
        achievements: ['Over 1,800 successful hysteroscopic procedures', '98% patient satisfaction rate', 'Pioneer in office-based hysteroscopy', 'Advanced fertility enhancement program', 'Excellence award in women\'s healthcare', 'Comprehensive minimally invasive services'],
        reviews: [
            { name: 'Lakshmi Devi', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', rating: 5, review: "Dr. Priya Sharma performed my hysteroscopy with such care. The procedure was comfortable and recovery was quick. Excellent female-focused care!" },
        ...
        contact: { phone: '+91 9876543213', email: 'hysteroscopy@jananihospital.com', location: 'Block D, 2nd Floor', hours: 'Mon-Sat: 9 AM - 6 PM | Consultation: By Appointment' },
        faq: [
            ...
            { question: 'How long is the recovery time after hysteroscopy?', answer: 'Recovery is typically quick. Most patients can return to normal activities within 1-2 days for diagnostic procedures and 3-5 days for operative procedures.' },
            { question: 'Can hysteroscopy help with fertility issues?', answer: 'Yes, hysteroscopy can identify and treat uterine factors affecting fertility such as polyps, fibroids, septum, and adhesions, potentially improving conception rates.' }
        ]
    };
                        ...
                        <div className="text-white max-w-4xl">
                            ...
                            <div className="flex items-center space-x-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg text-teal-100 mt-2 font-medium">Advanced Women's Healthcare</p>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-2xl p-6 shadow-xl sticky top-20 border-2 border-teal-100">
                                <div className="bg-teal-600 text-white text-center py-3 rounded-xl mb-6">
                                    <h3 className="text-lg font-bold">Contact Hysteroscopy Dept.</h3>
                                ...
                                <div className="mt-6 p-4 bg-teal-50 rounded-xl border border-teal-100">
                                    <p className="text-xs text-gray-600 text-center">
                                        <span className="font-bold text-teal-700">Female-Only</span> comfortable environment available
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800 mb-3">Advanced Hysteroscopic Services</h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">Comprehensive minimally invasive procedures for women's health with precision and care.</p>
                    </div>
            ...
            <section className="py-12 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800 mb-3">Our Hysteroscopy Experts</h2>
                        <p className="text-gray-600">Meet our team of experienced gynecologists specializing in minimally invasive procedures</p>
                    </div>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">Real experiences from women who trusted us with their healthcare needs.</p>
                    </div>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">Find answers to common questions about hysteroscopic procedures and women's health</p>
                    </div>
                    ...
                    <div className="mt-10 text-center">
                        <div className="bg-teal-50 border-2 border-teal-100 rounded-2xl p-8 max-w-2xl mx-auto">
                            ...
                            <p className="text-gray-600 mb-4">Our hysteroscopy experts are here to provide personalized consultation and care</p>
