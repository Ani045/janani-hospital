...
const Infertility = () => {
    ...
    const departmentData = {
        ...
        hero: '/Infertility-Treatment-Center/Infertility%20Treatment%20Center-banner.png',
        ...
        services: [
            { name: 'Female Infertility Treatment', description: 'Comprehensive evaluation and treatment of female infertility conditions with advanced diagnostics.', icon: FiHeart, procedures: ['Ovulation Disorders', 'PCOS Treatment', 'Endometriosis Care', 'Tubal Factor Treatment'], stats: { patients: '800+', success: '68%' }, image: '/Infertility-Treatment-Center/Female-Infertility-Treatment.png' },
            { name: 'Male Infertility Treatment', description: 'Specialized evaluation and treatment of male infertility factors using modern techniques.', icon: FiUsers, procedures: ['Sperm Analysis', 'Varicocele Treatment', 'Hormone Therapy', 'Surgical Sperm Retrieval'], stats: { patients: '600+', success: '62%' }, image: '/Infertility-Treatment-Center/Male-Infertility-Treatment.png' },
            { name: 'Fertility Testing & Diagnosis', description: 'Comprehensive fertility testing and diagnostic services for both partners.', icon: FiMonitor, procedures: ['Hormone Testing', 'HSG', 'Ultrasound Monitoring', 'Genetic Testing'], stats: { patients: '1.2K+', success: '98%' }, image: '/Infertility-Treatment-Center/Fertility-Testing%20&%20Diagnosis.png' },
            { name: 'Ovulation Induction', description: 'Advanced ovulation induction therapies to improve fertility and conception rates.', icon: FiTarget, procedures: ['Clomiphene Therapy', 'Gonadotropin Treatment', 'Letrozole Protocol', 'Ovulation Monitoring'], stats: { patients: '900+', success: '75%' }, image: '/Infertility-Treatment-Center/Ovulation-Induction.png' },
            { name: 'Laparoscopic Surgery', description: 'Minimally invasive surgical procedures to treat fertility-related conditions.', icon: FiTool, procedures: ['Endometriosis Surgery', 'Ovarian Cyst Removal', 'Tubal Surgery', 'Adhesion Removal'], stats: { patients: '400+', success: '85%' }, image: '/Infertility-Treatment-Center/Laparoscopic-Surgery.png' },
            { name: 'Fertility Counseling', description: 'Professional psychological support and counseling throughout your fertility journey.', icon: FiShield, procedures: ['Individual Counseling', 'Couple Therapy', 'Support Groups', 'Stress Management'], stats: { patients: '1K+', success: '90%' }, image: '/Infertility-Treatment-Center/Fertility-Counseling.png' }
        ],
        doctors: [
        ...
        contact: { phone: '+91 70908 31208', email: 'Jananihospital2018@gmail.com', hours: 'Mon-Sat: 8 AM - 6 PM | Sun: 9 AM - 2 PM' },
        faq: [
                        ...
                        <div className="text-white max-w-4xl">
                            <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base md:text-lg text-teal-100 mt-1 sm:mt-2 font-medium">Your Journey to Parenthood</p>
                                </div>
                            </div>
