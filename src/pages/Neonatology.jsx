...
const Neonatology = () => {
    ...
    const departmentData = {
        ...
        hero: '/Neonatology.webp',
        description: 'Our Neonatology Department provides specialized care for newborns, especially premature and critically ill infants, with a Level III NICU and expert neonatologists available 24/7.',
        overviewStats: [
            { icon: FiBaby, number: '3K+', label: 'Newborns Cared' },
            { icon: FiShield, number: '99%', label: 'Survival Rate' },
            { icon: FiAward, number: 'Level III', label: 'NICU Standard' },
            { icon: FiClock, number: '24/7', label: 'Emergency Care' }
        ],
        highlights: ['Level III NICU Facility', 'Expert Neonatologist Team', 'Advanced Ventilation Support', 'Comprehensive Developmental Care', 'Parent-Friendly Environment', '24/7 Emergency Neonatal Services'],
        services: [
            { name: 'Neonatal Intensive Care', description: 'Comprehensive intensive care for critically ill newborns with advanced life support systems and monitoring.', icon: FiMonitor, procedures: ['Mechanical Ventilation', 'Central Line Care', 'Therapeutic Hypothermia', 'Continuous Monitoring'], stats: { patients: '1.5K+', success: '99%' }, image: 'https://images.unsplash.com/photo-1551190822-a9333d879b1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Premature Baby Care', description: 'Specialized care for premature infants with advanced incubators, nutrition support, and developmental monitoring.', icon: FiBaby, procedures: ['Incubator Care', 'Feeding Support', 'Temperature Regulation', 'Growth Monitoring'], stats: { patients: '1.2K+', success: '98%' }, image: 'https://images.unsplash.com/photo-1581093452422-48b4f3b8f5b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Respiratory Support', description: 'Advanced respiratory care including mechanical ventilation and non-invasive breathing support for newborns.', icon: FiActivity, procedures: ['CPAP Support', 'High-Flow Nasal Cannula', 'Surfactant Therapy', 'Oxygen Therapy'], stats: { patients: '900+', success: '97%' }, image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Neonatal Surgery Support', description: 'Comprehensive perioperative care for newborns requiring surgical intervention with specialized monitoring.', icon: FiTarget, procedures: ['Pre-operative Stabilization', 'Post-surgical Monitoring', 'Pain Management', 'Wound Care'], stats: { patients: '400+', success: '96%' }, image: 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Developmental Care', description: 'Specialized developmental support programs to promote optimal growth and neurodevelopment in critically ill infants.', icon: FiHeart, procedures: ['Kangaroo Care', 'Developmental Positioning', 'Sensory Support', 'Family-Centered Care'], stats: { patients: '800+', success: '95%' }, image: 'https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Transport & Emergency', description: 'Specialized neonatal transport team and emergency services for critical newborn transfers and urgent care.', icon: FiShield, procedures: ['Emergency Resuscitation', 'Neonatal Transport', 'Critical Care Transport', '24/7 Emergency Response'], stats: { patients: '600+', success: '99%' }, image: 'https://images.unsplash.com/photo-1582719471384-894fbb16e074?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' }
        ],
        doctors: [
            { name: 'Dr. Anjali Sharma', specialization: 'Senior Neonatologist & NICU Director', experience: '18 years', image: 'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.9, expertise: ['Neonatal Intensive Care', 'Premature Care', 'Respiratory Management'] },
            { name: 'Dr. Rajesh Kumar', specialization: 'Neonatologist & Pediatric Intensivist', experience: '15 years', image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.8, expertise: ['Critical Care', 'Ventilator Management', 'Neonatal Emergencies'] },
            { name: 'Dr. Priya Reddy', specialization: 'Developmental Pediatrician', experience: '12 years', image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.7, expertise: ['Developmental Assessment', 'Early Intervention', 'Family Support'] },
            { name: 'Dr. Suresh Menon', specialization: 'Neonatal Surgeon', experience: '20 years', image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.9, expertise: ['Neonatal Surgery', 'Congenital Anomalies', 'Minimally Invasive Surgery'] }
        ],
        technology: [
            { name: 'Advanced Ventilators', description: 'State-of-the-art neonatal ventilators with sophisticated monitoring and gentle ventilation modes.', icon: FiMonitor },
            { name: 'High-Tech Incubators', description: 'Advanced incubators with precise temperature, humidity, and oxygen control systems.', icon: FiTool },
            { name: 'Continuous Monitoring', description: 'Real-time monitoring of vital signs, oxygen levels, and neurological activity.', icon: FiGlobe },
            { name: 'Mobile NICU Setup', description: 'Portable intensive care equipment for emergency neonatal transport services.', icon: FiShield }
        ],
        facilities: ['Level III NICU (20 Beds)', 'Neonatal Operating Theater', 'Isolation Rooms for Infection Control', 'Family Accommodation Rooms', 'Lactation Support Center', 'Developmental Care Unit', 'Transport Incubators', 'Emergency Resuscitation Bay'],
        achievements: ['Over 3000 newborns successfully treated', '99% survival rate in NICU', 'Level III NICU accreditation', 'Excellence award in neonatal care', 'First hospital with cooling therapy', 'Leading center for premature baby care'],
        reviews: [
            { name: 'Rajesh & Kavitha', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', rating: 5, review: "Our premature baby received exceptional care in the NICU. Dr. Anjali and her team were incredible - they saved our baby's life and supported us throughout the journey." },
        ...
        contact: { phone: '+91 9876543219', email: 'neonatology@jananihospital.com', location: 'Block D, 2nd Floor', hours: '24/7 Emergency NICU | Family Visits: 24/7' },
        faq: [
            ...
            { question: 'What care do you provide for premature babies?', answer: 'Our premature baby care includes specialized incubators, nutritional support, respiratory assistance, temperature regulation, and developmental care programs. We have expertise in managing complications of prematurity and supporting growth and development.' },
            { question: 'Do you have emergency neonatal transport services?', answer: 'Yes, we have a specialized neonatal transport team available 24/7 for emergency transfers. Our mobile NICU equipment allows us to provide intensive care during transport to ensure safe transfer of critically ill newborns.' }
        ]
    };
                        ...
                        <div className="text-white max-w-4xl">
                            ...
                            <div className="flex items-center space-x-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg text-teal-100 mt-2 font-medium">Expert Newborn & Infant Care</p>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            <div className="bg-white rounded-2xl p-8 shadow-md border border-gray-100">
                                <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center">
                                    ...
                                    Why Choose Our Neonatology Department?
                                </h2>
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-2xl p-6 shadow-xl sticky top-20 border-2 border-teal-100">
                                <div className="bg-teal-600 text-white text-center py-3 rounded-xl mb-6">
                                    <h3 className="text-lg font-bold">Contact NICU</h3>
                                ...
                                <div className="mt-6 p-4 bg-teal-50 rounded-xl border border-teal-100">
                                    <p className="text-xs text-gray-600 text-center">
                                        <span className="font-bold text-teal-700">24/7 Emergency Support</span> available for critical newborns
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800 mb-3">Comprehensive Neonatal Care</h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">From intensive care to developmental support, we provide complete newborn care with advanced medical expertise.</p>
                    </div>
            ...
            <section className="py-12 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800 mb-3">Our Neonatology Experts</h2>
                        <p className="text-gray-600">Meet our team of specialized doctors dedicated to providing the best care for newborns and infants</p>
                    </div>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800 mb-3">What Families Say</h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">Real stories from families whose newborns received exceptional care in our NICU.</p>
                    </div>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">Find answers to common questions about our neonatal intensive care services</p>
                    </div>
                    ...
                    <div className="mt-10 text-center">
                        <div className="bg-teal-50 border-2 border-teal-100 rounded-2xl p-8 max-w-2xl mx-auto">
                            ...
                            <p className="text-gray-600 mb-4">Our neonatology specialists are here to help you with expert guidance for your newborn's care</p>
