...
services: [
{ name: 'Endourology', description: 'Minimally invasive procedures for urinary tract disorders using advanced endoscopic techniques.', icon: FiMonitor, procedures: ['Ureteroscopy', 'PCNL', 'Cystoscopy', 'Urethral Stricture Repair'], stats: { patients: '2K+', success: '98%' }, image: 'https://images.unsplash.com/photo-1551190822-a9333d879b1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Kidney Stone Management', description: 'Comprehensive treatment for kidney stones with laser and minimally invasive techniques.', icon: FiDroplet, procedures: ['ESWL', 'Laser Lithotripsy', 'PCNL', 'Ureteroscopy'], stats: { patients: '1.8K+', success: '97%' }, image: 'https://images.unsplash.com/photo-1581093452422-48b4f3b8f5b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Prostate Care', description: 'Complete care for prostate health, including BPH treatment and prostate cancer management.', icon: FiShield, procedures: ['TURP', 'Laser Prostatectomy', 'Prostate Biopsy', 'Radical Prostatectomy'], stats: { patients: '1.5K+', success: '96%' }, image: 'https://images.unsplash.com/photo-1606037039918-a6a3fb4a37b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Male Infertility', description: 'Specialized care for male reproductive health and fertility issues with advanced treatment options.', icon: FiHeart, procedures: ['Varicocele Surgery', 'Sperm Retrieval', 'Hormone Therapy', 'Microsurgical Repair'], stats: { patients: '800+', success: '85%' }, image: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Urological Oncology', description: 'Comprehensive cancer care for kidney, bladder, prostate, and other urological cancers.', icon: FiTarget, procedures: ['Nephrectomy', 'Cystectomy', 'Tumor Ablation', 'Immunotherapy'], stats: { patients: '600+', success: '92%' }, image: 'https://images.unsplash.com/photo-1584362917165-526a968579e8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Pediatric Urology', description: 'Specialized urological care for children with congenital and acquired urological conditions.', icon: FiBaby, procedures: ['Hypospadias Repair', 'Undescended Testis', 'Vesicoureteral Reflux', 'Ureteropelvic Junction Obstruction'], stats: { patients: '400+', success: '97%' }, image: 'https://images.unsplash.com/photo-1628771065518-0d82f1938462?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' }
],
doctors: [
...
<p className="text-lg text-teal-100 mt-2 font-medium">Advanced Urological Care in Hyderabad</p>
</div>
</div>
