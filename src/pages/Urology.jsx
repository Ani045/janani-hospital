...
const {
    ...
    FiMonitor, FiGlobe, FiTool, FiChevronDown, FiDroplet
} = FiIcons;
...
const Urology = () => {
    ...
    const departmentData = {
        ...
        hero: '/Urology-Department/Urology-Department.png',
        ...
        overviewStats: [
            ...
            { icon: FiDroplet, number: '3K+', label: 'Stone Procedures' },
            { icon: FiClock, number: '24/7', label: 'Emergency Care' }
        ],
        highlights: ['Advanced Endourology & Laser Surgery', 'Laparoscopic & Robotic Urology', 'Comprehensive Kidney Stone Management', 'Male Infertility & Andrology Clinic', 'Dedicated Prostate Care Center', '24/7 Emergency Urological Services'],
        services: [
            { name: 'Endourology', description: 'Minimally invasive procedures for urinary tract disorders using advanced endoscopic techniques.', icon: FiMonitor, procedures: ['Ureteroscopy', 'PCNL', 'Cystoscopy', 'Urethral Stricture Repair'], stats: { patients: '2K+', success: '98%' }, image: '/Urology-Department/Endourology.png' },
            { name: 'Kidney Stone Management', description: 'Comprehensive treatment for kidney stones with laser and minimally invasive techniques.', icon: FiDroplet, procedures: ['ESWL', 'Laser Lithotripsy', 'PCNL', 'Ureteroscopy'], stats: { patients: '1.8K+', success: '97%' }, image: '/Urology-Department/Kidney-Stone-Management.png' },
            { name: 'Prostate Care', description: 'Complete care for prostate health, including BPH treatment and prostate cancer management.', icon: FiShield, procedures: ['TURP', 'Laser Prostatectomy', 'Prostate Biopsy', 'Radical Prostatectomy'], stats: { patients: '1.5K+', success: '96%' }, image: '/Urology-Department/Prostate-Care.png' },
            { name: 'Male Infertility', description: 'Specialized care for male reproductive health and fertility issues with advanced treatment options.', icon: FiHeart, procedures: ['Varicocele Surgery', 'Sperm Retrieval', 'Hormone Therapy', 'Microsurgical Repair'], stats: { patients: '800+', success: '85%' }, image: '/Urology-Department/Male-Infertility.png' },
            { name: 'Urological Oncology', description: 'Comprehensive cancer care for kidney, bladder, prostate, and other urological cancers.', icon: FiTarget, procedures: ['Nephrectomy', 'Cystectomy', 'Tumor Ablation', 'Immunotherapy'], stats: { patients: '600+', success: '92%' }, image: '/Urology-Department/Urological-Oncology.png' },
            { name: 'Pediatric Urology', description: 'Specialized urological care for children with congenital and acquired urological conditions.', icon: FiBaby, procedures: ['Hypospadias Repair', 'Undescended Testis', 'Vesicoureteral Reflux', 'Ureteropelvic Junction Obstruction'], stats: { patients: '400+', success: '97%' }, image: '/Urology-Department/Pediatric-Urology.png' }
        ],
        doctors: [
            ...
            { name: 'Dr. Anita Sharma', specialization: 'Uro-Oncologist', experience: '18 years', image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.8, expertise: ['Urological Cancers', 'Robotic Surgery', 'Minimally Invasive Surgery'] },
            { name: 'Dr. Amit Patel', specialization: 'Pediatric Urologist', experience: '15 years', image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.8, expertise: ['Pediatric Urology', 'Reconstructive Surgery', 'Congenital Anomalies'] },
            { name: 'Dr. Priya Gupta', specialization: 'Endourologist', experience: '12 years', image: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.7, expertise: ['Stone Disease', 'PCNL', 'Laser Surgery'] }
        ],
        technology: [
            { name: 'Advanced Laser Systems', description: 'Holmium and Thulium lasers for precise stone fragmentation.', icon: FiMonitor },
            { name: 'Flexible Ureteroscopy', description: 'Latest generation flexible scopes for kidney stone treatment.', icon: FiTool },
            { name: 'Extracorporeal Shock Wave', description: 'ESWL for non-invasive kidney stone treatment.', icon: FiGlobe },
            { name: 'Robotic Surgery System', description: 'Da Vinci robot for precision urological procedures.', icon: FiShield }
        ],
        facilities: ['Advanced Endourology Suite', 'Laser Lithotripsy Unit', 'ESWL (Shock Wave Lithotripsy)', 'Robotic Surgery Platform', 'Urodynamics Laboratory', 'Male Fertility Clinic', 'Prostate Care Center', 'Pediatric Urology Unit'],
        achievements: ['Over 5,000 urological procedures performed', '98% success rate in stone treatments', 'First center to introduce robotic urology', '3000+ successful endoscopic procedures', 'Excellence award in urological care', '24/7 emergency urological services'],
        reviews: [
            { name: 'Vikram Singh', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', rating: 5, review: "Dr. Rajesh Kumar removed my kidney stones with laser surgery. The procedure was painless and I recovered quickly. Excellent care!" },
        ...
        faq: [
            ...
            { question: 'What is the recovery time for prostate surgery?', answer: 'Recovery time varies depending on the type of procedure. Minimally invasive procedures like laser prostatectomy typically have shorter recovery times of 1-2 weeks, while traditional surgery may require 4-6 weeks.' },
            { question: 'Do you treat pediatric urological conditions?', answer: 'Yes, we have specialized pediatric urologists who treat congenital and acquired urological conditions in children, including hypospadias, undescended testis, and urinary tract abnormalities.' }
        ]
    };
                        ...
                        <div className="text-white max-w-4xl">
                            ...
                            <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-teal-500/30 backdrop-blur-md rounded-xl sm:rounded-2xl flex items-center justify-center border-2 border-teal-400/50 shadow-xl flex-shrink-0">
                                    <SafeIcon icon={FiDroplet} className="text-2xl sm:text-3xl md:text-4xl text-white" />
                                </div>
                                <div>
                                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight leading-tight">{departmentData.name}</h1>
                                    <p className="text-sm sm:text-base md:text-lg text-teal-100 mt-1 sm:mt-2 font-medium">Advanced Urological Care in Hyderabad</p>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-2xl p-6 shadow-xl sticky top-20 border-2 border-teal-100">
                                <div className="bg-teal-600 text-white text-center py-3 rounded-xl mb-6">
                                    <h3 className="text-lg font-bold">Contact Urology Dept.</h3>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">From kidney stones to prostate care, we provide complete urological services with advanced minimally invasive techniques.</p>
                    </div>
            ...
            <section className="py-12 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800 mb-3">Our Urology Experts</h2>
                        <p className="text-gray-600">Meet our team of renowned urologists dedicated to excellence in urological care</p>
                    </div>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">Real stories from patients who experienced excellent urological care with us.</p>
                    </div>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">Find answers to common questions about our urological services and treatments</p>
                    </div>
                    ...
                    <div className="mt-10 text-center">
                        <div className="bg-teal-50 border-2 border-teal-100 rounded-2xl p-8 max-w-2xl mx-auto">
                            ...
                            <p className="text-gray-600 mb-4">Our urological experts are here to help you with personalized consultation and treatment plans</p>
