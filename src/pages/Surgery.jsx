...
services: [
{ name: 'Laparoscopic Surgery', description: 'Minimally invasive procedures for faster recovery and minimal scarring, including gallbladder, appendix, and hernia.', icon: FiMonitor, procedures: ['Cholecystectomy', 'Appendectomy', 'Hernia Repair', 'Colectomy'], stats: { patients: '2.5K+', success: '99%' }, image: 'https://images.unsplash.com/photo-1581093452422-48b4f3b8f5b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Abdominal Surgery', description: 'Comprehensive surgical solutions for various abdominal conditions, from GI to colorectal issues.', icon: FiActivity, procedures: ['Gastrointestinal Surgery', 'Hepatobiliary Surgery', 'Colorectal Surgery', 'Pancreatic Surgery'], stats: { patients: '1.8K+', success: '97%' }, image: 'https://images.unsplash.com/photo-1551190822-a9333d879b1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Breast Surgery', description: 'Specialized surgical treatment for breast conditions, including cancer and benign tumors.', icon: FiHeart, procedures: ['Lumpectomy', 'Mastectomy', 'Breast Reconstruction', 'Sentinel Node Biopsy'], stats: { patients: '800+', success: '98%' }, image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Thyroid Surgery', description: 'Advanced surgical procedures for thyroid disorders, including cancer and hyperthyroidism.', icon: FiTarget, procedures: ['Total Thyroidectomy', 'Lobectomy', 'Parathyroidectomy', 'Thyroid Cancer Surgery'], stats: { patients: '600+', success: '99%' }, image: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Trauma Surgery', description: '24/7 emergency surgical care for trauma patients with rapid response protocols.', icon: FiShield, procedures: ['Emergency Trauma Care', 'Multi-organ Surgery', 'Damage Control Surgery', 'Critical Care Surgery'], stats: { patients: '1.2K+', success: '95%' }, image: 'https://images.unsplash.com/photo-1584362917165-526a968579e8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Vascular Surgery', description: 'Specialized treatment for blood vessel disorders, including minimally invasive techniques.', icon: FiUsers, procedures: ['Angioplasty', 'Bypass Surgery', 'Varicose Vein Treatment', 'AV Fistula Creation'], stats: { patients: '900+', success: '96%' }, image: 'https://images.unsplash.com/photo-1628771065518-0d82f1938462?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' }
],
doctors: [
