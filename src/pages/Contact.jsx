...
const Contact = () => {
    ...
    const contactInfo = [
        ...
        },
        {
            icon: FiMail,
            title: 'Email Us',
            info: 'Jananihospital2018@gmail.com',
            color: 'text-blue-600',
            bgColor: 'bg-blue-50'
        },
        {
                        ...
                        >
                            <div className="bg-white rounded-[40px] p-8 shadow-xl border border-gray-100 hover:shadow-2xl hover:border-gray-200 transition-all duration-500">
                                ...
                                <form accept-charset='UTF-8' action='https://app.formester.com/forms/ZU90MDpYm/submissions' method='POST' className="space-y-4">
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full bg-teal-600 text-white py-4 rounded-xl font-bold hover:bg-teal-700 shadow-lg shadow-teal-600/30 transition-all duration-300 flex items-center justify-center space-x-2 hover:shadow-xl hover:shadow-teal-600/40 hover:scale-105"
                                    >
