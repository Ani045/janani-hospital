...
const IVF = () => {
  ...
  return (
    <div className="pt-16 bg-gray-50">
      {/* HERO */}
      <section className="relative min-h-[450px] h-[60vh] sm:h-[55vh] md:h-[60vh]">
        <div
        ...
        <div className="absolute inset-0 flex items-center z-10">
          <div className="container mx-auto px-6 sm:px-8 md:px-12">
            <div className="text-white max-w-4xl">
              <Link
                to="/"
                className="inline-flex items-center space-x-2 text-white/90 hover:text-white mb-4 transition-colors group"
              >
                <SafeIcon
                  icon={FiArrowLeft}
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-teal-100 mt-2 font-medium">
                    Leading Fertility Center in Hyderabad
                  </p>
                </div>
              </div>

              <p className="text-lg sm:text-xl text-white/95 max-w-3xl leading-relaxed">
              ...
              <div className="flex flex-wrap gap-3 mt-6">
                <Link
                  to="/appointment"
                  className="bg-white text-teal-700 px-6 py-3 rounded-lg font-semibold hover:bg-teal-50 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center space-x-2"
                ...
                <a
                  ...
                  className="bg-red-600/20 backdrop-blur-md text-white border-2 border-white/30 px-6 py-3 rounded-lg font-semibold hover:bg-red-600/30 transition-all flex items-center space-x-2"
      ...
      {/* Stats - add top margin at mobile */}
      <section className="relative z-10 mt-2 md:-mt-16">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">
              Meet our dedicated team of renowned fertility specialists committed to your reproductive success and well-being.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {departmentData.doctors.map((doctor, index) => (
              <article
                ...
                aria-label={`Profile of Dr. ${doctor.name}`}
              >
                ...
                <div className="p-4">
                  ...
                  <div className="mt-2 mb-3">
                    <div className="flex flex-wrap gap-1">
                      {doctor.expertise.slice(0, 2).map((exp, idx) => (
                        <span
                          key={idx}
                          className="bg-red-50 text-red-700 px-1.5 py-0.5 rounded text-xs font-medium"
                        >
                          {exp}
                        </span>
                      ))}
                  ...
                  <Link
                    to="/appointment"
                    className="w-full bg-teal-600 text-white py-2 rounded-lg font-semibold hover:bg-teal-700 transition-all flex items-center justify-center space-x-1 text-xs"
