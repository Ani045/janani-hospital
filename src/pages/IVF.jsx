...
const IVF = () => {
    ...
    const departmentData = {
        ...
        description: 'Our IVF & Fertility Center is a beacon of hope for couples dreaming of parenthood, offering world-class reproductive technologies with a 72% success rate and personalized care.',
        overviewStats: [
            { icon: FiUsers, number: '8K+', label: 'Happy Couples' },
            { icon: FiBaby, number: '5K+', label: 'Babies Born' },
            { icon: FiAward, number: '72%', label: 'Success Rate' },
            { icon: FiClock, number: '24/7', label: 'Support Care' }
        ],
        highlights: ['State-of-the-Art IVF Laboratory', 'Internationally Trained Fertility Experts', 'Advanced Genetic Testing & Screening', 'Personalized Treatment Protocols', 'Comprehensive Counseling Support', 'Affordable Treatment Packages'],
        services: [
            { name: 'IVF (In Vitro Fertilization)', description: 'Advanced IVF procedures using cutting-edge technology to help couples achieve their dream of parenthood.', icon: FiActivity, procedures: ['Conventional IVF', 'ICSI', 'IMSI', 'TESE/PESA'], stats: { patients: '2.5K+', success: '72%' }, image: 'https://images.unsplash.com/photo-1581093452422-48b4f3b8f5b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'IUI Treatment', description: 'Intrauterine Insemination for couples requiring less invasive fertility treatments with high success rates.', icon: FiHeart, procedures: ['Natural Cycle IUI', 'Stimulated Cycle IUI', 'Donor Sperm IUI', 'IUI with Ovulation Induction'], stats: { patients: '1.8K+', success: '45%' }, image: 'https://images.unsplash.com/photo-1579154212918-0a1f7c2f0f8a?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Fertility Preservation', description: 'Egg and sperm freezing services for individuals planning to preserve their fertility for future use.', icon: FiShield, procedures: ['Egg Freezing', 'Sperm Freezing', 'Embryo Freezing', 'Ovarian Tissue Cryopreservation'], stats: { patients: '800+', success: '95%' }, image: 'https://images.unsplash.com/photo-1606037039918-a6a3fb4a37b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Genetic Testing', description: 'Preimplantation genetic testing to ensure healthy embryos and prevent genetic disorders.', icon: FiMonitor, procedures: ['PGT-A', 'PGT-M', 'PGT-SR', 'Comprehensive Chromosome Screening'], stats: { patients: '1.2K+', success: '98%' }, image: 'https://images.unsplash.com/photo-1555448248-2571daf6344b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Donor Programs', description: 'Egg and sperm donation programs with thorough screening and matching for optimal success.', icon: FiUsers, procedures: ['Egg Donation', 'Sperm Donation', 'Embryo Donation', 'Surrogacy Programs'], stats: { patients: '950+', success: '68%' }, image: 'https://images.unsplash.com/photo-1593113598332-cd288d649433?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
            { name: 'Male Infertility', description: 'Comprehensive diagnosis and treatment of male infertility factors using advanced techniques.', icon: FiTarget, procedures: ['Varicocele Surgery', 'TESA/PESA', 'Hormone Therapy', 'Lifestyle Management'], stats: { patients: '1.5K+', success: '65%' }, image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' }
        ],
        doctors: [
            { name: 'Dr. Priya Sharma', specialization: 'Fertility Specialist & IVF Expert', experience: '18 years', image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.9, expertise: ['IVF/ICSI', 'Egg Freezing', 'Fertility Preservation'] },
            { name: 'Dr. Rahul Verma', specialization: 'Reproductive Endocrinologist', experience: '15 years', image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.8, expertise: ['Hormonal Disorders', 'PCOS Management', 'Male Infertility'] },
            { name: 'Dr. Anjali Patel', specialization: 'Embryologist', experience: '12 years', image: 'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.9, expertise: ['Embryo Culture', 'Vitrification', 'PGT'] },
            { name: 'Dr. Meera Reddy', specialization: 'Fertility Counselor', experience: '10 years', image: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.7, expertise: ['Emotional Support', 'Treatment Planning', 'Couple Counseling'] }
        ],
        technology: [
            { name: 'Advanced IVF Laboratory', description: 'Class 10000 cleanroom with state-of-the-art incubators.', icon: FiMonitor },
            { name: 'Time-Lapse Imaging', description: 'Embryo monitoring system for continuous observation.', icon: FiGlobe },
            { name: 'Genetic Testing Platform', description: 'NGS-based preimplantation genetic testing.', icon: FiTool },
            { name: 'Cryopreservation System', description: 'Advanced vitrification technology.', icon: FiShield }
        ],
        facilities: ['Advanced IVF Laboratory (Class 10000)', 'Andrology Laboratory', 'Genetic Testing Lab', 'Cryopreservation Unit', 'Counseling Rooms', 'Semen Collection Rooms', 'Operating Theater for Egg Retrieval', 'Embryology Research Lab'],
        achievements: ['Over 5000 babies born through IVF', '72% IVF success rate (above national average)', 'First center to introduce Time-Lapse Imaging', 'ISO certified IVF laboratory', 'Excellence award in reproductive medicine', '1000+ egg freezing procedures'],
        reviews: [
            { name: 'Ananya Sharma', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', rating: 5, review: "The team at Janani Hospital gave us the hope we had lost. Their expertise and compassionate care are unparalleled. We are forever grateful for our little miracle.", },
            { name: 'Rahul & Priya Verma', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', rating: 5, review: "From the first consultation to the final procedure, the entire process was smooth. The doctors and staff are incredibly supportive. Highly recommended for any couple.", },
            { name: 'Sunita Reddy', image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', rating: 5, review: "A very professional and ethical center. They guide you at every step. The state-of-the-art facilities gave us confidence. Thank you, Janani Hospital!", }
        ],
        contact: { phone: '+91 9876543211', email: 'ivf@jananihospital.com', location: 'Block B, 2nd Floor', hours: 'Mon-Sat: 8 AM - 6 PM | Sun: 9 AM - 2 PM' },
        faq: [
            { question: 'What is IVF and who is it for?', answer: 'In Vitro Fertilization (IVF) is a process where an egg is combined with sperm outside the body, in a lab. It\'s a primary treatment for infertility for couples who have been unable to conceive naturally.' },
            { question: 'What is the success rate of IVF at your center?', answer: 'Our IVF center has a high success rate of 72%, which is above the national average. Success rates can vary based on factors like age and cause of infertility.' },
            { question: 'How long does one IVF cycle take?', answer: 'A complete IVF cycle typically takes about four to six weeks, from the start of ovarian stimulation until the pregnancy test.' },
            { question: 'Is the IVF process painful?', answer: 'Most patients experience minimal discomfort. Procedures like egg retrieval are performed under mild sedation to ensure you are comfortable.' }
        ]
    };
                        ...
                        <div className="text-white max-w-4xl">
                            ...
                            <div className="flex items-center space-x-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg text-teal-100 mt-2 font-medium">Leading Fertility Center in Hyderabad</p>
                                </div>
                            </div>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800 mb-3">Comprehensive Fertility Services</h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">From basic fertility evaluation to advanced IVF procedures, we offer complete reproductive care tailored to your needs.</p>
                    </div>
            ...
            <section className="py-12 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600">Meet our team of renowned fertility specialists dedicated to your journey</p>
                    </div>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">Real stories from families who started their journey with us.</p>
                    </div>
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">Find answers to common questions about our IVF services and fertility treatments</p>
                    </div>
                    ...
                    <div className="mt-10 text-center">
                        <div className="bg-teal-50 border-2 border-teal-100 rounded-2xl p-8 max-w-2xl mx-auto">
                            ...
                            <p className="text-gray-600 mb-4">Our fertility experts are here to help you with personalized guidance</p>
