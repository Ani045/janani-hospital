        ...
        <div className="absolute inset-0 flex items-center z-10">
          <div className="container mx-auto px-4 sm:px-6 md:px-12">
            <div className="text-white max-w-4xl">
              <Link
                to="/"
                className="inline-flex items-center space-x-1.5 text-white/90 hover:text-white mb-3 sm:mb-4 transition-colors group"
              >
                <SafeIcon
                  icon={FiArrowLeft}
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white/95 max-w-3xl leading-relaxed">
