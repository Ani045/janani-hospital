...
FiMonitor, FiGlobe, FiTool, FiChevronDown, FiAmbulance,
} = FiIcons;
...
description: 'Our Critical Care Department provides comprehensive intensive care for critically ill patients with advanced monitoring and life support systems, ensuring the highest standards of emergency medical care and patient recovery.',
overviewStats: [
{ icon: FiUsers, number: '2.5K+', label: 'Critical Patients' },
{ icon: FiActivity, number: '94%', label: 'Recovery Rate' },
{ icon: FiAward, number: '24/7', label: 'ICU Coverage' },
{ icon: FiClock, number: 'Level III', label: 'ICU Level' }
],
highlights: ['Level III ICU Facility', 'Multidisciplinary Critical Care Team', 'Advanced Life Support Systems', '24/7 Specialist Coverage', 'Modern Patient Monitoring', 'Emergency Response Excellence'],
services: [
{ name: 'Medical ICU (MICU)', description: 'Comprehensive intensive care for patients with severe medical conditions requiring close monitoring and organ support.', icon: FiHeart, procedures: ['Ventilator Support', 'Hemodynamic Monitoring', 'Dialysis Support', 'Cardiac Care'], stats: { patients: '850+', success: '94%' }, image: 'https://images.unsplash.com/photo-1551190822-a9333d879b1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Surgical ICU (SICU)', description: 'Specialized post-operative intensive care for surgical patients requiring advanced monitoring and recovery support.', icon: FiActivity, procedures: ['Post-Op Monitoring', 'Pain Management', 'Wound Care', 'Respiratory Support'], stats: { patients: '650+', success: '96%' }, image: 'https://images.unsplash.com/photo-1581093452422-48b4f3b8f5b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Cardiac ICU (CICU)', description: 'Advanced cardiac intensive care for patients with complex heart conditions and post-cardiac surgery care.', icon: FiShield, procedures: ['Cardiac Monitoring', 'IABP Support', 'Arrhythmia Management', 'Heart Failure Care'], stats: { patients: '420+', success: '92%' }, image: 'https://images.unsplash.com/photo-1606037039918-a6a3fb4a37b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Trauma ICU', description: 'Specialized care for critically injured trauma patients requiring immediate life-saving interventions and monitoring.', icon: FiMonitor, procedures: ['Trauma Resuscitation', 'Multi-organ Support', 'Emergency Surgery', 'Critical Stabilization'], stats: { patients: '380+', success: '89%' }, image: 'https://images.unsplash.com/photo-1555448248-2571daf6344b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Neurological ICU', description: 'Intensive care for patients with severe neurological conditions including stroke, brain injury, and neurosurgery.', icon: FiUsers, procedures: ['ICP Monitoring', 'Stroke Care', 'Seizure Management', 'Neuro Rehabilitation'], stats: { patients: '320+', success: '91%' }, image: 'https://images.unsplash.com/photo-1593113598332-cd288d649433?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Respiratory ICU', description: 'Specialized care for patients with severe respiratory failure requiring advanced ventilatory support and ECMO.', icon: FiTarget, procedures: ['Mechanical Ventilation', 'ECMO Support', 'Tracheostomy Care', 'Respiratory Therapy'], stats: { patients: '280+', success: '93%' }, image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' }
],
doctors: [
{ name: 'Dr. Rajesh Kumar', specialization: 'Intensivist & Critical Care Specialist', experience: '20 years', image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.9, expertise: ['Critical Care Medicine', 'Ventilator Management', 'Emergency Medicine'] },
{ name: 'Dr. Sita Patel', specialization: 'Cardiac Intensivist', experience: '16 years', image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.8, expertise: ['Cardiac ICU', 'Heart Failure', 'IABP Management'] },
{ name: 'Dr. Anil Sharma', specialization: 'Trauma & Emergency Specialist', experience: '18 years', image: 'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.9, expertise: ['Trauma Care', 'Emergency Surgery', 'Multi-organ Support'] },
{ name: 'Dr. Meera Reddy', specialization: 'Neurological Intensivist', experience: '14 years', image: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.7, expertise: ['Neuro ICU', 'Stroke Care', 'ICP Management'] }
],
technology: [
{ name: 'Advanced Ventilators', description: 'State-of-the-art mechanical ventilators with lung-protective strategies.', icon: FiMonitor },
{ name: 'Hemodynamic Monitoring', description: 'Continuous cardiac output and pressure monitoring systems.', icon: FiGlobe },
{ name: 'ECMO Systems', description: 'Extracorporeal membrane oxygenation for advanced life support.', icon: FiTool },
{ name: 'Dialysis Equipment', description: 'Continuous renal replacement therapy (CRRT) systems.', icon: FiShield }
],
facilities: ['24-bed Medical ICU', '16-bed Surgical ICU', '12-bed Cardiac ICU', 'Trauma Resuscitation Bay', 'Isolation ICU Units', 'Central Monitoring Station', 'Family Conference Rooms', 'Emergency Response Team Base'],
achievements: ['Over 2500 critical patients saved annually', '94% overall ICU survival rate', 'First center with ECMO capability', 'NABH accredited ICU units', 'Excellence in trauma care award', '24/7 critical care specialist coverage'],
reviews: [
{ name: 'Ramesh Gupta', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', rating: 5, review: "The ICU team at Janani Hospital saved my father's life. Their expertise, dedication, and round-the-clock care during his critical condition was exceptional. Forever grateful!" },
...
{ question: 'How does the ICU team coordinate patient care?', answer: 'Our multidisciplinary team includes intensivists, nurses, respiratory therapists, pharmacists, and specialists who collaborate daily to provide comprehensive care tailored to each patient\'s needs.' },
{ question: 'What support is available for families of ICU patients?', answer: 'We provide family conference rooms, regular updates from medical team, social worker support, and counseling services to help families during this challenging time.' }
]
};
...
<p className="text-lg text-teal-100 mt-2 font-medium">Life-Saving Intensive Care</p>
</div>
</div>
...
<h3 className="text-lg font-bold">Contact Critical Care</h3>
<p className="text-teal-100 text-xs mt-1">Emergency & intensive care</p>
</div>
...
<span className="font-bold text-red-700">24/7 Critical Care</span> emergency support available
</p>
</div>
</div>
</div>
...
<h2 className="text-3xl font-bold text-gray-800 mb-3">Comprehensive Critical Care Services</h2>
<p className="text-gray-600 max-w-2xl mx-auto">From emergency trauma care to specialized ICU services, we provide life-saving critical care with advanced monitoring and support systems.</p>
</div>
...
<h2 className="text-3xl font-bold text-gray-800 mb-3">Our Critical Care Experts</h2>
<p className="text-gray-600">Meet our team of dedicated intensivists and critical care specialists</p>
</div>
...
<h2 className="text-3xl font-bold text-gray-800 mb-3">What Our Families Say</h2>
<p className="text-gray-600 max-w-2xl mx-auto">Real stories from families who experienced our critical care services during challenging times.</p>
</div>
...
<p className="text-gray-600 max-w-2xl mx-auto">Find answers to common questions about our critical care services and ICU facilities</p>
</div>
...
<p className="text-gray-600 mb-4">Our critical care team is available 24/7 for emergencies and consultations</p>
