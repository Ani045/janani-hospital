...
const CriticalCare = () => {
    ...
    const departmentData = {
        ...
        hero: '/Critical-Care-Department/Critical%20Care%20Department%20banner.png',
        ...
        services: [
            { name: 'Medical ICU (MICU)', description: 'Comprehensive intensive care for patients with severe medical conditions requiring close monitoring and organ support.', icon: FiHeart, procedures: ['Ventilator Support', 'Hemodynamic Monitoring', 'Dialysis Support', 'Cardiac Care'], stats: { patients: '850+', success: '94%' }, image: '/Critical-Care-Department/Medical-ICU-(MICU).png' },
            { name: 'Surgical ICU (SICU)', description: 'Specialized post-operative intensive care for surgical patients requiring advanced monitoring and recovery support.', icon: FiActivity, procedures: ['Post-Op Monitoring', 'Pain Management', 'Wound Care', 'Respiratory Support'], stats: { patients: '650+', success: '96%' }, image: '/Critical-Care-Department/Surgica- ICU (SICU).png' },
            { name: 'Cardiac ICU (CICU)', description: 'Advanced cardiac intensive care for patients with complex heart conditions and post-cardiac surgery care.', icon: FiShield, procedures: ['Cardiac Monitoring', 'IABP Support', 'Arrhythmia Management', 'Heart Failure Care'], stats: { patients: '420+', success: '92%' }, image: '/Critical-Care-Department/Cardia-ICU-(CICU).png' },
            { name: 'Trauma ICU', description: 'Specialized care for critically injured trauma patients requiring immediate life-saving interventions and monitoring.', icon: FiMonitor, procedures: ['Trauma Resuscitation', 'Multi-organ Support', 'Emergency Surgery', 'Critical Stabilization'], stats: { patients: '380+', success: '89%' }, image: '/Critical-Care-Department/Trauma-ICU.png' },
            { name: 'Neurological ICU', description: 'Intensive care for patients with severe neurological conditions including stroke, brain injury, and neurosurgery.', icon: FiUsers, procedures: ['ICP Monitoring', 'Stroke Care', 'Seizure Management', 'Neuro Rehabilitation'], stats: { patients: '320+', success: '91%' }, image: '/Critical-Care-Department/Neurologica- ICU.png' },
            { name: 'Respiratory ICU', description: 'Specialized care for patients with severe respiratory failure requiring advanced ventilatory support and ECMO.', icon: FiTarget, procedures: ['Mechanical Ventilation', 'ECMO Support', 'Tracheostomy Care', 'Respiratory Therapy'], stats: { patients: '280+', success: '93%' }, image: '/Critical-Care-Department/Respiratory-ICU.png' }
        ],
        doctors: [
                        ...
                        <div className="text-white max-w-4xl">
                            ...
                            <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-teal-500/30 backdrop-blur-md rounded-xl sm:rounded-2xl flex items-center justify-center border-2 border-teal-400/50 shadow-xl flex-shrink-0">
                                    <SafeIcon icon={FiHeart} className="text-2xl sm:text-3xl md:text-4xl text-white" />
                                </div>
                                <div>
                                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight leading-tight">{departmentData.name}</h1>
                                    <p className="text-sm sm:text-base md:text-lg text-teal-100 mt-1 sm:mt-2 font-medium">Life-Saving Intensive Care</p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-2 sm:gap-3 mt-4 sm:mt-6">
                                ...
                                <a href={`tel:${departmentData.contact.phone}`} className="bg-red-600/20 backdrop-blur-md text-white border-2 border-white/30 px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg text-sm sm:text-base font-semibold hover:bg-red-600/30 transition-all flex items-center space-x-1.5 sm:space-x-2">
                                    <SafeIcon icon={FiAmbulance} className="text-base sm:text-lg" />
                                    <span>Emergency</span>
                                </a>
                            </div>
                        </div>
