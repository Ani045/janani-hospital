...
const Paediatrics = () => {
    ...
    const departmentData = {
        ...
        hero: '/Paediatrics-Department/Paediatrics-Department.png',
        ...
        services: [
            { name: 'General Paediatrics', description: 'Comprehensive healthcare for children including routine check-ups, vaccinations, and treatment of common illnesses.', icon: FiHeart, procedures: ['Routine Check-ups', 'Vaccinations', 'Common Illnesses', 'Growth Monitoring'], stats: { patients: '5K+', success: '99%' }, image: '/Paediatrics-Department/General-Paediatrics.png' },
            { name: 'Neonatology', description: 'Specialized care for newborns, especially premature or ill infants, in our state-of-the-art NICU.', icon: FiBaby, procedures: ['NICU Care', 'Premature Baby Care', 'Neonatal Surgery', 'Newborn Screening'], stats: { patients: '1.2K+', success: '95%' }, image: '/Paediatrics-Department/Neonatology.png' },
            { name: 'Pediatric Surgery', description: 'Surgical procedures for children ranging from minor surgeries to complex operations with pediatric expertise.', icon: FiScissors, procedures: ['Appendectomy', 'Hernia Repair', 'Circumcision', 'Congenital Surgery'], stats: { patients: '800+', success: '98%' }, image: '/Paediatrics-Department/Pediatric-Surgery.png' },
            { name: 'Developmental Paediatrics', description: 'Assessment and management of developmental delays, autism, ADHD, and learning disabilities in children.', icon: FiTarget, procedures: ['Developmental Assessment', 'Autism Evaluation', 'ADHD Management', 'Learning Disability Support'], stats: { patients: '1.5K+', success: '92%' }, image: '/Paediatrics-Department/Developmental-Paediatrics.png' },
            { name: 'Pediatric Cardiology', description: 'Specialized heart care for children including diagnosis and treatment of congenital heart diseases.', icon: FiActivity, procedures: ['Heart Murmur Evaluation', 'Echocardiography', 'Congenital Heart Surgery', 'Cardiac Catheterization'], stats: { patients: '600+', success: '96%' }, image: '/Paediatrics-Department/Pediatric-Cardiology.png' },
            { name: 'Pediatric Emergency', description: '24/7 emergency care for children with specialized pediatric emergency protocols and staff.', icon: FiShield, procedures: ['Emergency Assessment', 'Trauma Care', 'Poisoning Treatment', 'Respiratory Emergency'], stats: { patients: '2K+', success: '98%' }, image: '/Paediatrics-Department/Pediatric-Emergency.png' }
        ],
        doctors: [
                        ...
                        <div className="text-white max-w-4xl">
                            ...
                            <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base md:text-lg text-teal-100 mt-1 sm:mt-2 font-medium">Leading Child Care Center in Hyderabad</p>
                                </div>
                            </div>
