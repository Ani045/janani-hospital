                        ...
                        <div className="text-white max-w-4xl">
                            ...
                            <div className="flex items-center space-x-4 mb-4">
                                <div className="w-16 h-16 bg-teal-500/30 backdrop-blur-md rounded-2xl flex items-center justify-center border-2 border-teal-400/50 shadow-xl">
                                    <SafeIcon icon={FiBone} className="text-4xl text-white" />
                                </div>
                                <div>
                                    <h1 className="text-4xl md:text-5xl font-bold tracking-tight">{departmentData.name}</h1>
                                    <p className="text-lg text-teal-100 mt-2 font-medium">Leading Bone & Joint Care Center</p>
                                </div>
                            </div>
            ...
            <section className="py-12 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800 mb-3">Our Orthopedic Experts</h2>
                        <p className="text-gray-600">Meet our team of renowned orthopedic specialists dedicated to your bone and joint health</p>
                    </div>
