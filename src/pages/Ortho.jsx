...
const Ortho = () => {
    ...
    const departmentData = {
        ...
        services: [
            { name: 'Joint Replacement', description: 'Advanced surgery for knee, hip, and shoulder joints using modern, long-lasting implants with robotic assistance.', icon: FiActivity, procedures: ['Total Knee Replacement', 'Hip Replacement', 'Shoulder Replacement', 'Revision Surgery'], stats: { patients: '3K+', success: '98%' }, image: '/ortho/Joint Replacement.jpg' },
            { name: 'Arthroscopic Surgery', description: 'Minimally invasive surgery for joint problems like ligament tears and cartilage damage using advanced techniques.', icon: FiMonitor, procedures: ['Knee Arthroscopy', 'Shoulder Arthroscopy', 'ACL Reconstruction', 'Meniscus Repair'], stats: { patients: '2.5K+', success: '99%' }, image: '/ortho/Arthroscopic Surgery.jpg' },
            { name: 'Spine Surgery', description: 'Comprehensive surgery for degenerative, traumatic, and deformity conditions of the spine with precision care.', icon: FiTarget, procedures: ['Spinal Fusion', 'Disc Replacement', 'Scoliosis Surgery', 'Laminectomy'], stats: { patients: '1.8K+', success: '96%' }, image: '/ortho/Spine Surgery.jpg' },
            { name: 'Sports Medicine', description: 'Specialized treatment for sports injuries and athletic performance enhancement with rehabilitation support.', icon: FiShield, procedures: ['ACL Reconstruction', 'Rotator Cuff Repair', 'Cartilage Restoration', 'Fracture Management'], stats: { patients: '1.5K+', success: '97%' }, image: '/ortho/Sports Medicine.jpg' },
            { name: 'Trauma & Fracture Care', description: 'Emergency orthopedic trauma care with immediate surgical intervention for complex fractures and injuries.', icon: FiUsers, procedures: ['Complex Fracture Fixation', 'Polytrauma Management', 'Emergency Surgery', 'Bone Reconstruction'], stats: { patients: '2K+', success: '95%' }, image: '/ortho/Trauma & Fracture Care.jpg' },
            { name: 'Pediatric Orthopedics', description: 'Specialized orthopedic care for children including congenital deformities and growth-related issues.', icon: FiHeart, procedures: ['Growth Plate Injuries', 'Scoliosis Treatment', 'Hip Dysplasia', 'Clubfoot Correction'], stats: { patients: '800+', success: '94%' }, image: '/ortho/Pediatric Orthopedics.jpg' }
        ],
        doctors: [
