...
const {
FiArrowLeft, FiHeart, FiEye, FiActivity, FiUsers, FiShield, FiTarget, FiCheckCircle,
...
description: 'Our state-of-the-art Endoscopy Department provides advanced diagnostic and therapeutic endoscopic procedures with precision imaging technology, ensuring accurate diagnosis and effective treatment for gastrointestinal conditions.',
overviewStats: [
{ icon: FiUsers, number: '3.5K+', label: 'Procedures Done' },
{ icon: FiEye, number: '2.8K+', label: 'Diagnostics' },
{ icon: FiAward, number: '98%', label: 'Accuracy Rate' },
{ icon: FiClock, number: '24/7', label: 'Emergency Care' }
],
highlights: ['Advanced HD Endoscopy Systems', 'Expert Gastroenterologists', 'Therapeutic Endoscopy Procedures', 'Real-time Imaging Technology', 'Comprehensive GI Care', 'Same-day Procedure Reports'],
services: [
{ name: 'Upper GI Endoscopy', description: 'Advanced examination of esophagus, stomach, and duodenum using high-definition endoscopes.', icon: FiActivity, procedures: ['Diagnostic EGD', 'Variceal Banding', 'Polypectomy', 'Foreign Body Removal'], stats: { patients: '1.5K+', success: '99%' }, image: 'https://images.unsplash.com/photo-1581093458791-9f3c3250e1d8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Colonoscopy', description: 'Comprehensive examination of the large intestine and rectum for screening and diagnostic purposes.', icon: FiEye, procedures: ['Screening Colonoscopy', 'Therapeutic Polypectomy', 'Biopsy Collection', 'Bowel Preparation'], stats: { patients: '1.2K+', success: '97%' }, image: 'https://images.unsplash.com/photo-1579154212918-0a1f7c2f0f8a?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'ERCP Procedures', description: 'Endoscopic retrograde cholangiopancreatography for biliary and pancreatic disorders.', icon: FiShield, procedures: ['Biliary Stenting', 'Stone Extraction', 'Stricture Dilation', 'Pancreatic Therapy'], stats: { patients: '450+', success: '95%' }, image: 'https://images.unsplash.com/photo-1606037039918-a6a3fb4a37b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Capsule Endoscopy', description: 'Innovative wireless capsule technology for small bowel examination and diagnosis.', icon: FiMonitor, procedures: ['Small Bowel Imaging', 'Bleeding Source Detection', 'Crohns Assessment', 'Tumor Detection'], stats: { patients: '380+', success: '92%' }, image: 'https://images.unsplash.com/photo-1555448248-2571daf6344b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'EUS (Endoscopic Ultrasound)', description: 'Advanced imaging combining endoscopy with ultrasound for detailed tissue examination.', icon: FiUsers, procedures: ['Pancreatic Imaging', 'FNA Biopsies', 'Staging Studies', 'Therapeutic EUS'], stats: { patients: '320+', success: '96%' }, image: 'https://images.unsplash.com/photo-1593113598332-cd288d649433?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Flexible Sigmoidoscopy', description: 'Examination of the lower portion of the colon using flexible endoscopic technology.', icon: FiTarget, procedures: ['Rectal Examination', 'Sigmoid Screening', 'Biopsy Collection', 'Polyp Removal'], stats: { patients: '850+', success: '98%' }, image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' }
],
doctors: [
{ name: 'Dr. Amit Sharma', specialization: 'Gastroenterologist & Endoscopy Specialist', experience: '16 years', image: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.9, expertise: ['Upper GI Endoscopy', 'ERCP', 'EUS'] },
{ name: 'Dr. Priya Reddy', specialization: 'Interventional Gastroenterologist', experience: '14 years', image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.8, expertise: ['Therapeutic Endoscopy', 'Colonoscopy', 'Polypectomy'] },
{ name: 'Dr. Rajesh Kumar', specialization: 'Advanced Endoscopy Specialist', experience: '18 years', image: 'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.9, expertise: ['ERCP', 'EUS', 'Capsule Endoscopy'] },
{ name: 'Dr. Meera Patel', specialization: 'Diagnostic Endoscopy Expert', experience: '12 years', image: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80', rating: 4.7, expertise: ['Screening Endoscopy', 'Biopsy Procedures', 'Emergency Endoscopy'] }
],
technology: [
{ name: 'HD Endoscopy Systems', description: 'High-definition imaging for superior visualization.', icon: FiMonitor },
{ name: 'Narrow Band Imaging', description: 'Enhanced mucosal visualization technology.', icon: FiGlobe },
{ name: 'Therapeutic Equipment', description: 'Advanced tools for interventional procedures.', icon: FiTool },
{ name: 'Digital Documentation', description: 'Complete digital imaging and reporting system.', icon: FiShield }
],
facilities: ['Advanced Endoscopy Suites', 'Recovery Areas with Monitoring', 'Therapeutic Equipment Suite', 'Digital Imaging Systems', 'Preparation Rooms', 'Sedation Monitoring Unit', 'Emergency Endoscopy Capability', 'Pathology Integration Lab'],
achievements: ['Over 3500 successful endoscopic procedures', '98% diagnostic accuracy rate', 'First center to introduce NBI technology', 'NABH accredited endoscopy unit', 'Excellence in therapeutic endoscopy', '24/7 emergency endoscopy services'],
reviews: [
{ name: 'Ravi Krishnan', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', rating: 5, review: "The endoscopy procedure was much more comfortable than I expected. The staff was professional and the advanced equipment made the entire process smooth and efficient." },
{ name: 'Sunita & Mohan Rao', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', rating: 5, review: "Dr. Sharma and his team provided excellent care during my colonoscopy. The preparation instructions were clear and the procedure was painless. Highly recommended!" },
{ name: 'Anitha Reddy', image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80', rating: 5, review: "The endoscopy department at Janani Hospital is world-class. Advanced technology, skilled doctors, and compassionate care made my diagnostic journey stress-free." }
],
contact: { phone: '+91 9876543212', email: 'endoscopy@jananihospital.com', location: 'Block C, 1st Floor', hours: 'Mon-Sat: 8 AM - 7 PM | Sun: 9 AM - 3 PM' },
faq: [
{ question: 'How should I prepare for an endoscopy procedure?', answer: 'Preparation varies by procedure type. For upper endoscopy, fast for 8-12 hours. For colonoscopy, follow specific bowel preparation instructions. Our team will provide detailed preparation guidelines.' },
{ question: 'Is sedation used during endoscopic procedures?', answer: 'Most patients receive conscious sedation to ensure comfort during procedures. Our anesthesia team monitors you throughout to ensure safety and comfort.' },
{ question: 'How long does an endoscopy procedure take?', answer: 'Upper endoscopy typically takes 15-30 minutes, while colonoscopy takes 30-60 minutes. Recovery time is usually 1-2 hours depending on sedation used.' },
{ question: 'When will I receive my endoscopy results?', answer: 'Preliminary results are available immediately after the procedure. If biopsies are taken, pathology results are typically available within 3-5 business days.' }
]
};
...
<SafeIcon icon={FiEye} className="text-4xl text-white" />
</div>
<div>
<h1 className="text-4xl md:text-5xl font-bold tracking-tight">{departmentData.name}</h1>
<p className="text-lg text-teal-100 mt-2 font-medium">Advanced Diagnostic Excellence</p>
</div>
</div>
...
Why Choose Our Endoscopy Department?
</h2>
...
<h3 className="text-lg font-bold">Contact Endoscopy Department</h3>
<p className="text-teal-100 text-xs mt-1">Advanced diagnostic care</p>
</div>
...
<span className="font-bold text-teal-700">24/7 Emergency Endoscopy</span> available for critical cases
</p>
</div>
</div>
</div>
...
<h2 className="text-3xl font-bold text-gray-800 mb-3">Comprehensive Endoscopic Services</h2>
<p className="text-gray-600 max-w-2xl mx-auto">From routine screening to advanced therapeutic procedures, we offer complete endoscopic care with state-of-the-art technology.</p>
</div>
...
<span className="font-bold text-teal-700">{service.stats.patients}</span> Procedures Done
</span>
</div>
...
<h2 className="text-3xl font-bold text-gray-800 mb-3">Our Endoscopy Experts</h2>
<p className="text-gray-600">Meet our team of skilled gastroenterologists and endoscopy specialists</p>
</div>
...
<p className="text-gray-600 max-w-2xl mx-auto">Real experiences from patients who received endoscopic care at our facility.</p>
</div>
...
<p className="text-gray-600 max-w-2xl mx-auto">Find answers to common questions about endoscopic procedures and diagnostic services</p>
</div>
...
<p className="text-gray-600 mb-4">Our endoscopy specialists are here to help with personalized guidance</p>
