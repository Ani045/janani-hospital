...
const Endoscopy = () => {
    ...
    const departmentData = {
        ...
        services: [
            { name: 'Upper GI Endoscopy', description: 'Advanced examination of esophagus, stomach, and duodenum using high-definition endoscopes.', icon: FiActivity, procedures: ['Diagnostic EGD', 'Variceal Banding', 'Polypectomy', 'Foreign Body Removal'], stats: { patients: '1.5K+', success: '99%' }, image: '/endoscopy/Upper GI Endoscopy.jpg' },
            { name: 'Colonoscopy', description: 'Comprehensive examination of the large intestine and rectum for screening and diagnostic purposes.', icon: FiEye, procedures: ['Screening Colonoscopy', 'Therapeutic Polypectomy', 'Biopsy Collection', 'Bowel Preparation'], stats: { patients: '1.2K+', success: '97%' }, image: '/endoscopy/Colonoscopy.jpg' },
            { name: 'ERCP Procedures', description: 'Endoscopic retrograde cholangiopancreatography for biliary and pancreatic disorders.', icon: FiShield, procedures: ['Biliary Stenting', 'Stone Extraction', 'Stricture Dilation', 'Pancreatic Therapy'], stats: { patients: '450+', success: '95%' }, image: '/endoscopy/ERCP Procedures.jpg' },
            { name: 'Capsule Endoscopy', description: 'Innovative wireless capsule technology for small bowel examination and diagnosis.', icon: FiMonitor, procedures: ['Small Bowel Imaging', 'Bleeding Source Detection', 'Crohns Assessment', 'Tumor Detection'], stats: { patients: '380+', success: '92%' }, image: '/endoscopy/Capsule Endoscopy.jpg' },
            { name: 'EUS (Endoscopic Ultrasound)', description: 'Advanced imaging combining endoscopy with ultrasound for detailed tissue examination.', icon: FiUsers, procedures: ['Pancreatic Imaging', 'FNA Biopsies', 'Staging Studies', 'Therapeutic EUS'], stats: { patients: '320+', success: '96%' }, image: '/endoscopy/EUS (Endoscopic Ultrasound).jpg' },
            { name: 'Flexible Sigmoidoscopy', description: 'Examination of the lower portion of the colon using flexible endoscopic technology.', icon: FiTarget, procedures: ['Rectal Examination', 'Sigmoid Screening', 'Biopsy Collection', 'Polyp Removal'], stats: { patients: '850+', success: '98%' }, image: '/endoscopy/Flexible Sigmoidoscopy.jpg' }
        ],
        doctors: [
        ...
        contact: { phone: '+91 70908 31208', email: 'Jananihospital2018@gmail.com', location: 'Block C, 1st Floor', hours: 'Mon-Sat: 8 AM - 7 PM | Sun: 9 AM - 3 PM' },
        faq: [
