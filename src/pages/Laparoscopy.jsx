...
services: [
{ name: 'Gynecological Laparoscopy', description: 'Minimally invasive treatment for various gynecological conditions including ovarian cysts, fibroids, and endometriosis.', icon: FiHeart, procedures: ['Ovarian Cyst Removal', 'Fibroid Removal', 'Hysterectomy', 'Endometriosis Treatment'], stats: { patients: '800+', success: '98%' }, image: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'General Laparoscopy', description: 'Advanced laparoscopic procedures for general surgical conditions with minimal scarring and faster recovery.', icon: FiScissors, procedures: ['Appendectomy', 'Cholecystectomy', 'Hernia Repair', 'Spleen Surgery'], stats: { patients: '700+', success: '99%' }, image: 'https://images.unsplash.com/photo-1581093452422-48b4f3b8f5b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Urological Laparoscopy', description: 'Minimally invasive treatment for urological conditions with precision and excellent outcomes.', icon: FiShield, procedures: ['Pyeloplasty', 'Nephrectomy', 'Prostate Surgery', 'Adrenal Surgery'], stats: { patients: '500+', success: '97%' }, image: 'https://images.unsplash.com/photo-1579154212918-0a1f7c2f0f8a?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Bariatric Laparoscopy', description: 'Weight loss surgery using minimally invasive techniques for sustainable results and better health.', icon: FiTarget, procedures: ['Gastric Sleeve', 'Gastric Bypass', 'Gastric Band', 'Revision Surgery'], stats: { patients: '400+', success: '95%' }, image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Thoracic Laparoscopy', description: 'Minimally invasive chest surgery for lung and thoracic conditions with precision instruments.', icon: FiActivity, procedures: ['Lung Biopsy', 'Pleural Surgery', 'Mediastinal Surgery', 'Thoracic Tumor Removal'], stats: { patients: '300+', success: '96%' }, image: 'https://images.unsplash.com/photo-1584362917165-526a968579e8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' },
{ name: 'Colorectal Laparoscopy', description: 'Advanced minimally invasive surgery for colon and rectal conditions with excellent patient outcomes.', icon: FiMonitor, procedures: ['Colon Resection', 'Rectal Surgery', 'Bowel Repair', 'Cancer Surgery'], stats: { patients: '350+', success: '97%' }, image: 'https://images.unsplash.com/photo-1628771065518-0d82f1938462?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80' }
],
doctors: [
...
<SafeIcon icon={FiMonitor} className="text-4xl text-white" />
</div>
<div>
<h1 className="text-4xl md:text-5xl font-bold tracking-tight">{departmentData.name}</h1>
<p className="text-lg text-teal-100 mt-2 font-medium">Minimally Invasive Surgery Excellence</p>
</div>
</div>
